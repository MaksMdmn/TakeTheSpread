...
public class OrderDaoImpl extends AbstractJDBCao<Order, Integer> {
    ...
    private static String SPECIAL_SELECT_ORDER = SELECT_ORDER + " WHERE (dt > " + getStartDayTime() + " AND state = \'Filled\')" + " ORDER BY dt DESC";
    ...
    public List<Order> readTodayFilledOrdersDesc() throws PersistException {
